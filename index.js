 ...
 * @returns {T} A random value from 'values'
 */
 ...
 * @returns {Array<T>} An array with with 'nrOfValues' random values from 'values'
 */
 ...
 * @param {Array<T>} values
 * @param {number} totalNrOfValues
 * @param {number} nrOfGroups
 * @returns {Array<Array<T>>} An array containing groups as arrays were the 'totalNrOfValues'
